...
instalar(){
        ...
        url="https://raw.githubusercontent.com/maxizamorano/maxtheme/release-v1.0/themes/max-theme-light.css"
        dir_archivo="/usr/local/hestia/web/css/themes/custom/max-theme-light.css"

        url_2="https://raw.githubusercontent.com/maxizamorano/maxtheme/release-v1.0/themes/max-theme-light-login.css"
